...
"}")
        icon = QIcon()
        icon.addFile(u"Final_Images/signal_icon.png", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        icon1 = QIcon()
        icon1.addFile(u"Final_Images/frequyncy_icon.png", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        icon2 = QIcon()
        icon2.addFile(u"Final_Images/temperature_icon.png", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        icon3 = QIcon()
        icon3.addFile(u"Final_Images/clock_icon.png", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        icon4 = QIcon()
        icon4.addFile(u"Final_Images/launch_icon.png", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        ...
        self.frequyncy_and_power_label.setMinimumSize(QSize(0, 20))
...
"}")
        ...
        self.power_minus_button.setFont(font2)
...
"}")
        ...
        self.frequyncy_minus_button.setFont(font2)
...
"}")
        ...
        self.frequyncy_value.setFont(font3)
...
"}")
        ...
        self.power_value.setFont(font3)
...
"}")
        ...
        self.temperature_minus_button.setFont(font2)
...
"	color: rgb(255, 255, 255);\n"
"}")
        self.thermometer_picture.setPixmap(QPixmap(u"Final_Images/term_icon.png"))
...
"}")
        ...
        self.timer_minus_button.setFont(font2)
...
"	color: rgb(255, 255, 255);\n"
"}")
        self.sand_wach_picture.setPixmap(QPixmap(u"Final_Images/sand_clock_icon.png"))
...
"}")
        icon5 = QIcon()
        icon5.addFile(u"Final_Images/load_icon.png", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        icon6 = QIcon()
        icon6.addFile(u"Final_Images/save_icon.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.signal_chosen_label.setFont(font6)
...
"")
        ...
        self.timer_chosen_label.setFont(font6)
...
"")
        ...
        self.temperature_chosen_label.setFont(font6)
...
"")
        ...
        self.frequyncy_chosen_label.setFont(font6)
...
"")
        ...
        self.power_chosen_label.setFont(font6)
...
"")
        ...
        self.launch_status_label.setFont(font)
...
"}")
        ...
        self.sensor_temperature_label.setGeometry(QRect(260, 208, 60, 31))
        self.sensor_temperature_label.setFont(font6)
...
"")
        ...
        self.sensor_pressure_label.setGeometry(QRect(173, 208, 85, 31))
        self.sensor_pressure_label.setFont(font6)
...
"")
        ...
        self.current_countdown_label.setGeometry(QRect(88, 208, 83, 31))
        self.current_countdown_label.setFont(font6)
...
"}")
        ...
        self.load_file_frame.setGeometry(QRect(10, 30, 300, 180))
...
"")
        ...
        self.previous_button.setFont(font3)
